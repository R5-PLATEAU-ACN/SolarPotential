...
| 同上      | Jageocoder | 2.0.0 | 住所ジオコーダライブラリ（不動産登記情報の所在地を登記所備付地図と突合するために使用） |
| 同上      | GEOS | 3.1.0 | 地理空間情報を処理するためのオープンソースライブラリ（Geometry Engine Open Source） |
| 同上      | Proj4 | 4.5.0 | 空間参照系変換ライブラリ |
